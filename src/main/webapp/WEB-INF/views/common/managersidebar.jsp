    ...
    <div id="sidebar">
      ...
      <div class="sidebar-inner-name1">
        <ul>
          ...
          <li>
            <a
              href="${ pageContext.servletContext.contextPath }/manager/mentilist"
              >멘티 조회</a
            >
          </li>
          <li>
            <a
              href="${ pageContext.servletContext.contextPath }/manager/mentolist"
              >멘토 조회</a
            >
          </li>
          <li>
            <a
              href="${ pageContext.servletContext.contextPath }/manager/manproduce"
              >관리자 계정 관리</a
            >
          </li>
        </ul>
        <ul>
          ...
          <li>
            <a
              href="${ pageContext.servletContext.contextPath }/manager/reportedmentee"
              >신고된 멘티</a
            >
          </li>
          <li>
            <a
              href="${ pageContext.servletContext.contextPath }/manager/reportedmentor"
              >신고된 멘토</a
            >
          </li>
          <li>
            <a
              href="${ pageContext.servletContext.contextPath }/manager/reportedboard"
              >신고된 게시판</a
            >
          </li>
        </ul>
