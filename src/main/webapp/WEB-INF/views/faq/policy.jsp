    ...
    <main>
      ...
      <div class="faq-2-tutee" id="info">
        <div>
          ...
          <h3>제1조 (목적)</h3>
          <h4>
            (주)탈잉 (이하 “회사”라 함)은 이용자의 개인정보를 소중하게 생각하고,
          ...
          <h4>
            1. 이용자 : 탈잉에 접속하여 탈잉 서비스 이용약관에 따라 회사가
            제공하는 서비스를 이용하는 자를 말하며 회원도 포함합니다.
          </h4>
          <h4>
            2. 서비스 : 구현되는 단말기(PC, 모바일, 태블릿 PC 등의 각종 유무선
            장치를 포함)와 상관없이 이용자가 이용할 수 있는 탈잉 서비스를
            의미합니다.
          </h4>
          <h4>
          ...
          <h4>
            ...
            탈잉에 정보를 제공하는 주체로써 사람이나 기관을 의미합니다.
          </h4>
          <h4>
          ...
          <h4>
            8. 유료서비스 : 탈잉 서비스를 통해 유료로 이용 가능한 회사가
          ...
          <h4>
            ...
            구매취소 등을 반복적으로 행하는 등 회사가 제공하는 탈잉 서비스
          ...
          <h4>
            ② 회사는 쿠키 정보를 수집하여 이용자들의 방문한 탈잉 각 서비스
          ...
          <h4>
            ...
            필요한 탈잉 일부 서비스는 이용에 어려움이 있을 수 있습니다.
          </h4>
          <h4>
      ...
      <div class="faq-2-tutee" id="service">
        <div>
          ...
          <h3>제1조 (목적)</h3>
          <h4>
            이 약관은 탈잉(이하 당사)이 제공하는 수업 연결 서비스를 이용함에
          ...
          <h4>
            가. 이 약관은 탈잉 사이트에 회원으로 등록, 조회 등 서비스 이용
            순간부터 효력이 발생됩니다.
          </h4>
          <h4>
          ...
          <h4>
            다. 서비스 : 탈잉 사이트와 모바일 탈잉에서 판매 가능한 상품으로
      ...
      <div class="faq-2-tutee" id="refund">
        <div>
          ...
          <h5>
            ...
            것은 가능하며 이에 대해서는 탈잉 측에서 관여하지 않습니다.
          </h5>
          <h5>
            ④ 수강생이 튜터에게 문제가 있다고 판단하여 수업 진행 및 환불을
            요청하는 경우, 탈잉 측에서는 개입할 수 있으며 이에 대한 사유 확인과
          ...
          <h5>
            ⑤ 약관에 규정된 회사의 탈잉안전결제서비스가 종료된 후 수업의 환불
          ...
          <h5>
            ...
            거부하는 경우, 탈잉 측에서는 개입할 수 있으며 이에 대한 사유 확인과
            수업 과정상에 문제는 없었는지 여부를 확인 합니다. 즉, 수업 진행상의
          ...
          <h5>
            ...
            튜터분에게 환불 조치 해드리는 것은 가능하며, 이에 대해서는 탈잉
